...
class Module extends AbstractModule
{
    ...
    public function install(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $connection->exec("CREATE TABLE omeka2item (id INT AUTO_INCREMENT NOT NULL, job_id INT NOT NULL, item_id INT NOT NULL, remote_id INT NOT NULL, endpoint VARCHAR(255) NOT NULL, INDEX IDX_59E62AA3BE04EA9 (job_id), UNIQUE INDEX UNIQ_59E62AA3126F525E (item_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;");
